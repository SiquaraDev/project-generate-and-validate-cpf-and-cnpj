"use strict";
const BTN_CPF_GENERATOR = document.getElementById("btn-cpf-generator");
const INPUT_CPF_GENERATOR = document.getElementById("cpf-generator");
const BTN_CPF_VALIDATOR = document.getElementById("btn-cpf-validator");
const INPUT_CPF_VALIDATOR = document.getElementById("cpf-validator");
const TEXT_CPF = document.getElementById("cpf-result");
const BTN_CLEAR_CPF_VALIDATOR = document.getElementById("btn-clear-cpf-validator");
const BTN_CNPJ_GENERATOR = document.getElementById("btn-cnpj-generator");
const INPUT_CNPJ_GENERATOR = document.getElementById("cnpj-generator");
const BTN_CNPJ_VALIDATOR = document.getElementById("btn-cnpj-validator");
const INPUT_CNPJ_VALIDATOR = document.getElementById("cnpj-validator");
const TEXT_CNPJ = document.getElementById("cnpj-result");
const BTN_CLEAR_CNPJ_VALIDATOR = document.getElementById("btn-clear-cnpj-validator");
...
function getRandomCpfWithoutDigits() {
    let min = 100000000;
    let max = 999999999;
    return Math.floor(Math.random() * (max - min + 1)) + min;
}
function getRandomCnpjWithoutDigits() {
